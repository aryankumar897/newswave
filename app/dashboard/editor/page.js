        ...
        <div className="row justify-content-center">
            ...
            <div className="nav flex-column nav-pills me-3" id="v-pills-tab" role="tablist" aria-orientation="vertical">
              ...
              <button
                ...
                id="v-pills-settings-tab" data-bs-toggle="pill" data-bs-target="#v-pills-settings" type="button" role="tab" aria-controls="v-pills-settings"
              ...
              <button
                className={
                  `nav-link  ${activeTab === "tab7" ? "active" : ""} `
                }
            ...
            <div className="tab-content" id="v-pills-tabContent">
              ...
              <div className={`tab-pane fade  ${activeTab === "tab3" ? "show active" : ""}`} id="v-pills-messages" role="tabpanel" aria-labelledby="v-pills-messages-tab"><NewsPost /> </div>

              <div
                className={`tab-pane fade  ${activeTab === "tab4" ? "show active" : ""}`}

                id="v-pills-settings" role="tabpanel" aria-labelledby="v-pills-settings-tab"><Table /></div>
              ...
              <div className={`tab-pane fade  ${activeTab === "tab6" ? "show active" : ""}`}
                id="v-pills-settings" role="tabpanel" aria-labelledby="v-pills-settings-tab"><Category /></div>

              <div
                className={`tab-pane fade  ${activeTab === "tab7" ? "show active" : ""}`}
