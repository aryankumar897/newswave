...
export default function Videolib({ searchParams }) {
...
const router=useRouter()
    ...
    const fetchvideolib = async (id) => {
        ...
        try {
            ...
            const response = await fetch(`${process.env.API}/admin/videolibget/${id}`)
            const data = await response.json()

            setVideolib(data)

            setVideolibImage(data?.image)
            setLoading(false)

        } catch (error) {
            setLoading(false)
            console.log("error fetching video library")
        }
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            setLoading(true)
            const backendResponse = await fetch(`${process.env.API}/admin/videolib/${id}`, {
            ...
            setSuccess(data?.msg)
            setError(null)
            router.push("/dashboard/admin/allvideo")
            console.log("video lib updated successfully")
